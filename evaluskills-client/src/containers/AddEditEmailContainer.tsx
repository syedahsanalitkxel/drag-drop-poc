...
import EmailTemplate from '../components/pages/AddEmailTemplate';
...
const EmailTemplateContainer: React.FunctionComponent<RouteComponentProps> = ({
  match,
  history,
}) => {
  ...
  if (Object.getOwnPropertyNames(match.params).length > 0) {
    return <EmailTemplate edit={true} />;
  }
