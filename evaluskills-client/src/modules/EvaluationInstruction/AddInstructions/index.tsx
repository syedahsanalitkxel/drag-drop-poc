...
interface Props {
  changeListener?: (formValues: AddInstructionsInterface) => void;
  edit?: boolean;
  list?: any;
}
...
export const AddInstructions: React.FunctionComponent<Props> = ({ list, edit, changeListener }) => {
  ...
  function submitForm(values: AddInstructionsInterface, formikActions: FormikActions<AddInstructionsInterface>) {
