            ...
            <Fragment>
                ...
                <div className="form-group row m-b-0">
                    ...
                    <div className="col-sm-3 col-form-label font-bold">
                        ...
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea"
                            name={`expstatement[${this.props.comNumber}].expstatement`}
                            placeholder={'Add Statement'}
                            invalid={this.props.formikprops.touched && this.props.formikprops.errors && this.props.formikprops.errors.expstatement && this.props.formikprops.touched.expstatement ? (this.props.formikprops.touched.expstatement[this.props.comNumber].expstatement && this.props.formikprops.errors.expstatement[this.props.comNumber].expstatement) : null}

                            onChange={this.onhandlechange} />
                        <FormFeedback tooltip={true} >
                            {this.props.formikprops.errors && this.props.formikprops.errors.expstatement ? this.props.formikprops.errors.expstatement[this.props.comNumber].expstatement : null}
                        </FormFeedback>
                    ...
                    <div className="col-sm-3 col-form-label b-r border-left">
                        <Input className="assesmentTextarea"
                            ...
                            name={'expBehaviour'}
                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['expBehaviour'] && this.props.formikprops.errors['expBehaviour'])}
                    ...
                    <div className="col-sm-3 col-form-label">
                        <Input className="assesmentTextarea"
                            ...
                            name={'expscaling'}
                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['expscaling'] && this.props.formikprops.errors['expscaling'])}
                ...
                <div className="form-group row m-b-0">
                    ...
                    <div className="col-sm-3 col-form-label font-bold">
                        <Input className="assesmentTextarea"
                            ...
                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['excstatement'] && this.props.formikprops.errors['excstatement'])}
                    ...
                    <div className="col-sm-3 col-form-label b-r border-left">
                        <Input className="assesmentTextarea"
                            ...
                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['excbehaviour'] && this.props.formikprops.errors['excbehaviour'])}
                    ...
                    <div className="col-sm-3 col-form-label">
                        <Input className="assesmentTextarea"
                            ...
                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['excscaling'] && this.props.formikprops.errors['excscaling'])}
                ...
                <div className="form-group row m-b-0">
                    <label className="col-sm-2 col-form-label font-bold d-flex align-items-center">3 - Competent/ Meet&nbsp,Expectation</label>
                    <div className="col-sm-3 col-form-label font-bold">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'comstatement'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['comstatement'] && this.props.formikprops.errors['comstatement'])}
                    ...
                    <div className="col-sm-3 col-form-label b-r border-left">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'combehavior'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['combehavior'] && this.props.formikprops.errors['combehavior'])}
                    ...
                    <div className="col-sm-3 col-form-label">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'comscaling'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['comscaling'] && this.props.formikprops.errors['comscaling'])}
                ...
                <div className="form-group row m-b-0">
                    ...
                    <div className="col-sm-3 col-form-label font-bold">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'marstatement'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['marstatement'] && this.props.formikprops.errors['marstatement'])}
                    ...
                    <div className="col-sm-3 col-form-label b-r border-left">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'marbehaviour'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['marbehaviour'] && this.props.formikprops.errors['marbehaviour'])}
                    ...
                    <div className="col-sm-3 col-form-label">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'marscaling'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['marscaling'] && this.props.formikprops.errors['marscaling'])}
                ...
                <div className="form-group row m-b-0">
                    ...
                    <div className="col-sm-3 col-form-label font-bold">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'unstatement'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['unstatement'] && this.props.formikprops.errors['unstatement'])}
                    ...
                    <div className="col-sm-3 col-form-label b-r border-left">
                        <Input className="assesmentTextarea"
                            aria-multiline='true'
                            rows={2}
                            type="textarea" name={'unbehaviour'}

                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['unbehaviour'] && this.props.formikprops.errors['unbehaviour'])}
                    ...
                    <div className="col-sm-3 col-form-label">
                        <Input className="assesmentTextarea"
                            ...
                            name={'unscaling'}
                            placeholder={'Add Statement'}
                            invalid={!!(this.props.formikprops.touched['unscaling'] && this.props.formikprops.errors['unscaling'])}
