...
const clientFormSchema = Yup.object().shape({
  ...
  contactEmail: stringValidation(2, 50, true),
  contactFirstName: stringValidation(2, 50, true),
  contactLastName: stringValidation(2, 50, true),
  contactPhone: stringValidation(2, 50, true),
  contactRole: stringValidation(2, 50, true),
