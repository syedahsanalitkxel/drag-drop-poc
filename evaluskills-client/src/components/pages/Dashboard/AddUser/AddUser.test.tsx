...
describe('MyComponent', () => {
    ...
    it('4 Input fields in `.form`', () => {
        const wrapper = mount(<Router><AddUser /></Router>);
    ...
    it('First Name label exist ', () => {
        const wrapper = render(<Router><AddUser /></Router>);
    ...
    describe('Component functionality', () => {
        it('should not submit if required fields are empty', () => {
            ...
            componentRender.find('Formik').instance().props.onSubmit(badFormValues, {resetForm});
