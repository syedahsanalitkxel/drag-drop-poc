...
class EditAssessment extends Component<any, State> {
	...
	public render() {
		...
		return (
			<DashboardTemplate>
				<Formik
					initialValues={{ categorySelected: this.state.categorySelected, definiation: '', expstatement: '', expBehaviour: '', expscaling: '', excstatement: '', excbehaviour: '', excscaling: '', comstatement: '', combehavior: '', comscaling: '', marstatement: '', marbehaviour: '', marscaling: '', unstatement: '', unbehaviour: '', unscaling: '' }}
