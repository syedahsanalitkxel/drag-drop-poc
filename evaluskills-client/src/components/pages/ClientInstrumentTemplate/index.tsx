...
import ListCardItems from '../../organisms/ClientListCardItems';
...
const ClientInstrumentTemplate: React.FunctionComponent<Props> = ({
  instrumentTemplates,
  add,
...
export default ClientInstrumentTemplate;
